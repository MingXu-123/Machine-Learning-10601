...
def plot(average_log_likelihood_lst_train, average_log_likelihood_lst_valid):
    ...
    a = plt.plot(x, average_log_likelihood_lst_train)
    b = plt.plot(x, average_log_likelihood_lst_valid)
...
def train(theta_vec, feature_lst_train, labels_train, \
    ...
    return theta_vec, average_log_likelihood_lst, average_log_likelihood_lst_valid, epoch_lst
