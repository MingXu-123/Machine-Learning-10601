...
def train_NN_SGD(train_data, train_labels, test_data, test_labels, \
	...
	for epoch in range(num_epoch):
		...
		train_entropy_lst.append(train_entropy)
		test_entropy_lst.append(test_entropy)
	return alpha, beta, metrics_str, train_entropy_lst, test_entropy_lst
...
def plot(train_entropy_lst, test_entropy_lst):
	x = [i for i in range(100)]
	a = plt.plot(x, train_entropy_lst, linewidth=3, color="green")
	b = plt.plot(x, test_entropy_lst, linewidth=3, color="blue")
	plt.xlabel('Number of epochs')
	plt.ylabel('Average Cross Entropy')
	plt.title('Average_Cross_Entropy vs Number of epochs')
	plt.legend(('Train Average Cross Entropy', 'Test Average Cross Entropy'), loc='upper')
	plt.show()
	return None
...
def main():
	...
	learned_alpha, learned_beta, metrics_str, train_entropy_lst, test_entropy_lst = \
		train_NN_SGD(train_data, train_labels, test_data, test_labels, alpha, beta, num_epoch, learning_rate)
	...
	plot(train_entropy_lst, test_entropy_lst)
	average_train_entropy = sum(train_entropy_lst) / len(train_entropy_lst)
	average_test_entropy = sum(test_entropy_lst) / len(test_entropy_lst)
	print("average_train_entropy is ", average_train_entropy)
	print("average_test_entropy is ", average_test_entropy)
